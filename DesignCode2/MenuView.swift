    ...
    var body: some View {
        VStack {
            ...
            .padding(.horizontal, 30)
                //views in SwiftUI are clipped by the corner radius, Scroll view or clip shape. That makes it hard to float elements. We have the Overlay modifier which allows you to avoid clipping
                .overlay(
                    Image("Avatar")
                        .resizable()
